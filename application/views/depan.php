...
<div class="col-md-12">
  ...
  <br /> 
  <br /> 
  <h4><b>SISTEM INFORMASI PENERIMAAN SISWA BARU<br /><?= strip_tags(cari('nama')) ?></b></h4>
  <small><b><i>Jl.<?= strip_tags(cari('jalan')) ?> | Telp : <?= strip_tags(cari('telp')) ?></i></b></small>
    ...
    box-shadow: 0px 0px 0px #000;">
             ...
             <div class="alert alert-info" style="border-radius: 0px;border:none;color: #df9c0e"> <h3 class="box-title"><i class="fa fa-book"></i> CARA PENDAFTARAN </h3></div>
              <br />
