...
<h1> <h4>REKAPITULASI PENERIAMAAN PESERTA PELATIHAN BALAI KERJA TAHUN. <?= $tahun_akademik ?></h4></h1>
 <h4><?= strip_tags(cari('nama')) ?></h4>
 <small><i><?= strip_tags(cari('jalan')) ?>Telp .<?= strip_tags(cari('telp')) ?></i></small> 
<hr />
  </div>
...
$html2pdf->Output('LAPORAN PENERIMAAN SISWA BARU.pdf');
?>
