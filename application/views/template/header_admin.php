...
<?php if($this->session->userdata('level') == "admin"): ?>
   ...
   <li class="treeview">
        <a href="">
            <i class="fa fa-cubes"></i>
            <span>Setting Tahun Akademik</span>
            <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu" style="display: none;">
              <li><a href="<?= base_url('admin\setting_app') ?>"><i class="fa fa-circle-o"></i>Setting </a></li>               
        </ul>
    </li>
...
<section class="content-header">
    ...
    <div class="box">
      ...
      <div class="col-md-8"> <h4> <i class="fa fa-share fa-spin"></i><?= $judul ?></h4></div> 
      </div>