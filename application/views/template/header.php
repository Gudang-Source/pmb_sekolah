        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="callout callout-info" style="height: 50px">
              <div class="col-md-8"> <h4> <i class="fa fa-share"></i><?= $judul ?></h4></div><div class="col-md-4"><marquee>SELAMAT DATANG DI HALAMAN ADMINISTRATOR <?= ucfirst($this->session->userdata('nama')) ?></marquee></div>
            </div>