...
<center>
 <img src="<?= base_url('/assets/admin/dist/img/proc.png') ?>" class="img-responsive" onerror="this.src = '<?= base_url('assets/no-image.jpg') ?>';">
 <br />
 <h3>PANITIA PENERIMAAN PESERTA PELATIHAN BALAI KERJA</h3>
